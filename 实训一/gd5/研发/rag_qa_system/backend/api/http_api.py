...
class HttpApi:
    ...
    def get_conversation(self, session_id: str) -> dict:
        return self.qa_controller.get_history(session_id)

    def clear_conversation(self, payload: dict) -> dict:
        return self.qa_controller.clear_history(payload.get("session_id", ""))
